...
\title[]{Adiabatic preparation of fractional quantum Hall phases from the thin torus limit}
\author{\texorpdfstring{\textbf {Benjamin Michen} (TU Dresden) \\ C\'{e}cile Repellin (Univ. Grenoble-Alpes, CNRS, LPMMC)\\
 Jan Carl Budich (TU Dresden), \newline \vspace{10pt} Contact: \url{benjamin.michen@mailbox.tu-dresden.de}}{}}
\date{06.09.2022}
