...
def Fig_1(N, N_colorsteps, r, epsilon_1, epsilon_2, gamma, gamma_2, gamma_3, data_location, data_location_inset):
    ...
    a2.legend(loc="upper left", bbox_to_anchor=(0., 0.83), fontsize = label_size)
    """
    ...
    a2.text(0.5, 0.94, r"(b)", fontsize = label_size, transform=a2.transAxes, horizontalalignment = "center")
    
    a1.text(0.5,0.94, r"(a)", fontsize = label_size, transform=a1.transAxes, horizontalalignment = "center")
    
    fig.tight_layout()
    fig.savefig("QHE_wo_CB_DPG.png",  bbox_inches='tight', dpi = 600)
