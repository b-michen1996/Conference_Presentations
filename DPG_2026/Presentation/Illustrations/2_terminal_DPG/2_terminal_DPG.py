...
def Fig_2_terminal_DPG(location_a, location_b, location_data_inset_a, location_data_inset_b, nu = True):
    ...
    if nu:
        fig.savefig("2_terminal_DPG_nu.png", bbox_inches='tight', dpi = 300)
    else:
        fig.savefig("2_terminal_DPG_no_nu.png", bbox_inches='tight', dpi = 300)
...
def main():                    
    ...
    nu = True
    Fig_2_terminal_DPG(Data_Fig_2_a, Data_Fig_2_b, location_data_inset_a, location_data_inset_b, nu)
